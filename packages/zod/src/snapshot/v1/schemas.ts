...
export const ExhaustiveFormatsParamsSchema = z.object({
  ...
  stringDate: z.date().optional(),
  stringDateTime: z.date().optional(),
  integerNoFormat: z.number().int().optional(),
  integerInt32: z.number().int().optional(),
  integerInt64: z.number().int().optional(),
  numberNoFormat: z.number().optional(),
  numberFloat: z.number().optional(),
  numberDouble: z.number().optional(),
});
...
export const ExhaustiveParamsParamsSchema = z.object({
  ...
  queryNumber: z.number().optional(),
  queryInteger: z.number().int().optional(),
  queryBoolean: z.boolean().optional(),
  queryStringArray: z.string().array().optional(),
  queryEnumArray: ExhaustiveParamsQueryEnumArraySchema.array().optional(),
  queryNumberArray: z.number().array().optional(),
  queryIntegerArray: z.number().int().array().optional(),
  queryBooleanArray: z.boolean().array().optional(),
  pathString: z.string(),
  pathEnum: ExhaustiveParamsPathEnumSchema,
  pathNumber: z.number(),
  pathInteger: z.number().int(),
  pathBoolean: z.boolean(),
  pathStringArray: z.string().array(),
  pathEnumArray: ExhaustiveParamsPathEnumArraySchema.array(),
  pathNumberArray: z.number().array(),
  pathIntegerArray: z.number().int().array(),
  pathBooleanArray: z.boolean().array(),
  headerString: z.string().optional(),
  headerEnum: ExhaustiveParamsHeaderEnumSchema.optional(),
  headerNumber: z.number().optional(),
  headerInteger: z.number().int().optional(),
  headerBoolean: z.boolean().optional(),
  headerStringArray: z.string().array().optional(),
  headerEnumArray: ExhaustiveParamsHeaderEnumArraySchema.array().optional(),
  headerNumberArray: z.number().array().optional(),
  headerIntegerArray: z.number().int().array().optional(),
  headerBooleanArray: z.boolean().array().optional(),
