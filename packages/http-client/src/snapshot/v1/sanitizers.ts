/**
 * This code was generated by @basketry/typescript-validators@0.1.0-rc.12
 *
...
export function sanitizeExampleUnion(
  ...
  if (validators.isGizmo(obj)) {
    return sanitizeGizmo(obj);
  } else {
    return []; // sanitizeString(obj); // TODO: support primitives in unions
  }
}
...
export function sanitizeUploadGizmoParams(
  params: types.UploadGizmoParams,
): types.UploadGizmoParams {
  // Create new object based on method parameters.
  const sanitized: types.UploadGizmoParams = {
    data: params.data,
  };
